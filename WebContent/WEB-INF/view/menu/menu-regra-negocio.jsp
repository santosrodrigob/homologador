...
<c:import url="../menu/imports-css.jsp"></c:import>
	...
	<nav>
		<div class="nav-wrapper grey darken-1">
		  ...
		  <ul class="right hide-on-med-and-down">
		    <!-- Dropdown Trigger -->
		    <li><a class="dropdown-trigger" href="#!" data-target="dropdown2"><strong>Manutenção de Regra</strong><i class="material-icons center">arrow_drop_down</i></a></li>
	...
	<ul id="dropdown2" class="dropdown-content">
		<li><a href="entrada?controller=RegraNegocio&acao=Open&filtrar=1">Filtrar</a></li>
		<li class="divider"></li>
		<li><a href="entrada?controller=RegraNegocio&acao=Open">Novo</a></li>
		<li><a href="entrada?controller=RegraNegocio&acao=Listar">Listar</a></li>
	</ul>
